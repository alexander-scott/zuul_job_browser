...
export class JobManager {
	...
	get_all_jobs_in_document(uri: vscode.Uri): NewJob[] {
	 ...
	 */
	get_job_at(wordRange: vscode.Range): NewJob | undefined {
	 ...
	 */
	get_parent_job_from_job_name(job_name: string): NewJob | undefined {
	 ...
	 * @param string job_name
	 */
	get_job_with_name(job_name: string): NewJob | undefined {
	 ...
	 * @param string job_name
	 */
	get_all_jobs_with_name(job_name: string): NewJob[] {
	 ...
	 * @param string job_name
	 */
	get_all_jobs_with_this_parent(job_name: string): NewJob[] {
